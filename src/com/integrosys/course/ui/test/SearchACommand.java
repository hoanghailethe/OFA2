...
public class SearchACommand extends AbstractCommand {
    ...
    public String[][] getParameterDescriptor() {
        return (new String[][]{
                {"searchKey", String.class.getName(), REQUEST_SCOPE},
                {"searchValue", String.class.getName(), REQUEST_SCOPE},
        });
    }
    ...
    public HashMap doExecute(HashMap map) throws CommandProcessingException, CommandValidationException {
        ...
        Collection c = null;
        String field = (String) map.get("searchKey");
        String key = (String) map.get("searchValue");
